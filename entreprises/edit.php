...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/annuaire-entreprises/entreprises/show.php?id=<?= (int)$id ?>" class="btn btn-secondary">Retour</a>
        </div>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <?php if ($logoActuel !== ''): ?>
                        <div class="mb-3">
                            ...
                            <img
                                src="/annuaire-entreprises/uploads/logos/<?= htmlspecialchars($logoActuel) ?>"
                                alt="Logo actuel"
                                class="img-fluid"
